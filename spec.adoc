...
** If use of a protocol file is burdensome then https://cbor.io[CBOR] footnote:[https://tools.ietf.org/html/rfc7049] could be used instead. CBOR appears to have create comparably-sized Server Responses (as protobuf), but Client Requests are larger as they require the Request method inside the request.
